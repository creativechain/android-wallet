...
import com.gotcreations.materialpin.PinCompatActivity;
import com.gotcreations.materialpin.PinFragmentActivity;

/**
 * Allows to handle the {@link com.gotcreations.materialpin.managers.AppLock} from within
...
public class LockManager<T extends AppLockActivity> {
    ...
    /**
     * The static singleton instance of {@link com.gotcreations.materialpin.managers.AppLock}
     */
     ...
     * {@link com.gotcreations.materialpin.PinActivity}
     */
    ...
    /**
     * Tells the app if the {@link com.gotcreations.materialpin.managers.AppLock} is enabled or not
     */
