package com.gotcreations.materialpin.managers;
...
public abstract class AppLock {
    ...
    /**
     * EXTRA_TYPE, uses to pass to the {@link com.gotcreations.materialpin.managers.AppLockActivity}
     ...
     * take into account for the {@link com.gotcreations.materialpin.PinActivity}. These activities
     * will not log the last opened time, will not launch the
     * {@link com.gotcreations.materialpin.managers.AppLockActivity} etc...
     */
    ...
    /**
     * Get logo resource id used by {@link com.gotcreations.materialpin.managers.AppLockActivity}
     */
    public abstract int getLogoId();

    /**
     * Set logo resource id used by {@link com.gotcreations.materialpin.managers.AppLockActivity}
     */
    public abstract void setLogoId(int logoId);

    /**
     * Get the forgot option used by {@link com.gotcreations.materialpin.managers.AppLockActivity}
     */
    public abstract boolean shouldShowForgot();

    /**
     * Set the forgot option used by {@link com.gotcreations.materialpin.managers.AppLockActivity}
     */
    ...
    /**
     * Enable the {@link com.gotcreations.materialpin.managers.AppLock} by setting
     * {@link com.gotcreations.materialpin.managers.AppLockImpl} as the
     * {@link com.gotcreations.materialpin.interfaces.LifeCycleInterface}
     */
    public abstract void enable();

    /**
     * Disable the {@link com.gotcreations.materialpin.managers.AppLock} by removing any
     * {@link com.gotcreations.materialpin.interfaces.LifeCycleInterface}
     */
    ...
    /**
     * Disable the {@link com.gotcreations.materialpin.managers.AppLock} by removing any
     * {@link com.gotcreations.materialpin.interfaces.LifeCycleInterface} and also delete
     ...
     * Set in {@link com.gotcreations.materialpin.interfaces.LifeCycleInterface#onActivityPaused(Activity)}
     * and {@link com.gotcreations.materialpin.interfaces.LifeCycleInterface#onActivityResumed(Activity)}
     */
     ...
     * {@link com.gotcreations.materialpin.encryption.Encryptor} class.
     */
    ...
    /**
     * Evaluates if:
     * - we are already into the {@link com.gotcreations.materialpin.managers.AppLockActivity}
     * - the passcode is not set
     * - the timeout didn't reached
     * If any of this is true, then we don't need to start the
     * {@link com.gotcreations.materialpin.managers.AppLockActivity} (it returns false)
